...
Pod::Spec.new do |s|
  s.name             = 'IGCMacros'
  s.version          = '0.1.0'
  s.summary          = 'A short description of IGCMacros.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/gia-vt/IGCMacros'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gia-vt' => 'jason@ingenuity.ph' }
  s.source           = { :git => 'https://github.com/gia-vt/IGCMacros.git', :tag => s.version.to_s }
